import { Mode, Song } from "../../types/youtube.types.ts";
...
export const RenderTracks = ({ tracks, query, mode }: RenderTracksProps) => {
    ...
    <>
      {
        <section>
          <div className="flex items-center justify-between mb-3">
            <Link to={`/ytsearch/tracks/${mode}/${encodeURIComponent(query)}`}>
